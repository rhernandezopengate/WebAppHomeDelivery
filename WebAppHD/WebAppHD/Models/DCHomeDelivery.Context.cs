...
namespace WebAppHD.Models
{
    ...
    public partial class DB_A3F19C_OGEntities : DbContext
    {
        ...
        public virtual DbSet<rt_det_paquetes_skus> rt_det_paquetes_skus { get; set; }
        public virtual DbSet<rt_paquete> rt_paquete { get; set; }
        public virtual DbSet<skus> skus { get; set; }
        public virtual DbSet<pickers> pickers { get; set; }
        public virtual DbSet<statuspickers> statuspickers { get; set; }
    }
}
